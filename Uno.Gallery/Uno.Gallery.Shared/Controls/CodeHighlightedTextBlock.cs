...
namespace ShowMeTheCSharp
{
	...
	public class CodeHighlightedTextBlock : Control
	{
		...
		/// </summary>
		public HighlightLanguages HighlightLanguage
		{
			get { return (HighlightLanguages)GetValue(HighlightLanguageProperty); }
		...
		public static readonly DependencyProperty HighlightLanguageProperty = DependencyProperty.Register(
			nameof(HighlightLanguages),
			typeof(HighlightLanguages),
			typeof(CodeHighlightedTextBlock),
			new PropertyMetadata(HighlightLanguages.PlainText, OnCodeChanged)
		);
		...
		private void RenderCode()
		{
			...
			try
			{
				...
				switch (HighlightLanguage)
				{
					...
					//	break;
					case HighlightLanguages.CSharp:
